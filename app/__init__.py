...
from app import index, user_send_email, user_register, user_login, user_token_check, \
    ...
    movie_similar, movie_likelist, movie_search, movie_comment, movie_suggest, movie_wordcloud, \
    person_list, person_like, person_detail, person_latest, person_top, person_partners, person_likelist, person_search
